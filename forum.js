...
<!--Maybe add in author?-->
       ...
       <div class="vstack" style="align-items: start">
           <h3 class="closeText" style="font-size: larger; font-family: Lexend, sans-serif; font-weight: 400; word-break: break-word">${title}</h3>
           <p class="closeText" style="text-align: start; font-size: medium; font-family: Lexend, sans-serif; font-weight: 250; word-break: break-word"> ${content} </p> <!--Change to only show 200 chars?--> <!--fix on 4/9-->
    `;
    //(await postDiv != null);
